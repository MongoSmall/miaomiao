    ...
    <div class="search_body">
        ...
        <div class="search_result">
            ...
            <ul>
                <!-- <li>
                    <div class="img">
                        <img src="/images/movie_1.jpg"></div>
                    <div class="info">
        ...
        message(newVal){
            ...
            this.axios.get('/api/searchList?cityId=10&kw='+newVal,{
                ...
                if(this.axios.isCancel(err)){
                    console.log('Request canceled',err.message);//请求如果被取消，这是返回被取消的message
...
.search_body .search_input{ padding: 8px 10px; background-color: #e6e6e6; border-bottom: 1px solid #e5e5e5;}
